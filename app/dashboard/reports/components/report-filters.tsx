      ...
      <div className="mb-8">
        <FilterBar>
          <FilterBarGroup className="min-w-[180px] sm:max-w-[210px]">
            <HugeiconsIcon icon={Wallet01Icon} className="size-3.5 shrink-0 text-muted-foreground" strokeWidth={2} />
          ...
          >
            <HugeiconsIcon icon={SlidersHorizontalIcon} className="h-3.5 w-3.5" strokeWidth={2} />
            Filters
            {activeFilterCount > 0 && (
        ...
        <CollapsibleContent className="overflow-hidden border-b border-border/20 data-[state=closed]:animate-collapsible-up data-[state=open]:animate-collapsible-down">
          <div className="grid gap-px bg-border/12 lg:grid-cols-5">
            <FilterSelect
              icon={<HugeiconsIcon icon={HashIcon} className="h-3 w-3"  strokeWidth={2}/>}
              label="Symbol"
            ...
            />
            <FilterSelect
              icon={<HugeiconsIcon icon={Clock01Icon} className="h-3 w-3"  strokeWidth={2}/>}
              label="Session"
            ...
            />
            <FilterSelect
              icon={<HugeiconsIcon icon={CircleCheckIcon} className="h-3 w-3"  strokeWidth={2}/>}
              label="Outcome"
            ...
            />
            <FilterSelect
              icon={<HugeiconsIcon icon={Target01Icon} className="h-3 w-3"  strokeWidth={2}/>}
              label="Strategy"
            ...
            />
            <FilterSelect
              icon={<HugeiconsIcon icon={Alert02Icon} className="h-3 w-3"  strokeWidth={2}/>}
              label="Rule Status"
