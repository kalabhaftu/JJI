  ...
  return (
    ...
    >
      <DocsSection title="1. Create your account">
        ...
        <DocsCardGrid>
          <DocsInfoCard
            icon={<HugeiconsIcon icon={CheckmarkCircle02Icon} strokeWidth={2} color="currentColor" />}
      ...
      <DocsSection title="2. Choose a subscription plan">
        ...
        <DocsCardGrid>
          <DocsInfoCard
            icon={<HugeiconsIcon icon={Settings02Icon} strokeWidth={2} color="currentColor" />}
      ...
      <DocsSection title="3. Import your first trades">
        ...
        <DocsCardGrid>
          <DocsInfoCard
            icon={<HugeiconsIcon icon={FileImportIcon} strokeWidth={2} color="currentColor" />}
            title="CSV import"
