...
export function LinkedAccounts({ plain = false }: { plain?: boolean }) {
  ...
  const getProviderIcon = (provider: string) => {
    switch (provider) {
      case 'discord':
        return <HugeiconsIcon icon={Message01Icon} className="h-4 w-4" strokeWidth={2} color="currentColor" />
      case 'google':
        return <HugeiconsIcon icon={Globe02Icon} className="h-4 w-4" strokeWidth={2} color="currentColor" />
      case 'email':
        return <HugeiconsIcon icon={Mail01Icon} className="h-4 w-4" strokeWidth={2} color="currentColor" />
      default:
        return <HugeiconsIcon icon={AlertCircleIcon} className="h-4 w-4" strokeWidth={2} color="currentColor" />
    }
  }
        ...
        <div className="space-y-4">
          <div>
            <h3 className="text-base font-semibold flex items-center gap-2">
              <HugeiconsIcon icon={Link01Icon} className="h-5 w-5" strokeWidth={2} color="currentColor" />
              Linked Accounts
            </h3>
                    ...
                    <AlertDialog>
                      <AlertDialogTrigger asChild>
                        <Button variant="secondary" size="sm" className="w-full sm:w-auto">
                          <HugeiconsIcon icon={Unlink01Icon} className="h-4 w-4 sm:mr-2" strokeWidth={2} color="currentColor" />
        ...
        <div className="space-y-2">
          {!isDiscordLinked && (
            <Button
              ...
              disabled={linking}
            >
              <HugeiconsIcon icon={Message01Icon} className="mr-2 h-4 w-4" strokeWidth={2} color="currentColor" />
              Link Discord
            </Button>
          )}
          {!isGoogleLinked && (
            <Button
              ...
              disabled={linking}
            >
              <HugeiconsIcon icon={Globe02Icon} className="mr-2 h-4 w-4" strokeWidth={2} color="currentColor" />
              Link Google
            </Button>
          )}
