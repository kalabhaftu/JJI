...
const edgeVariant: Record<MagicTabVariant, string> = {
  default:
    "[background:linear-gradient(to_left,color-mix(in_srgb,hsl(var(--primary))_50%,black)_0%,color-mix(in_srgb,hsl(var(--primary))_75%,black)_8%,color-mix(in_srgb,hsl(var(--primary))_75%,black)_92%,color-mix(in_srgb,hsl(var(--primary))_50%,black)_100%)]",
  secondary:
    "[background:linear-gradient(to_left,color-mix(in_srgb,hsl(var(--secondary))_50%,black)_0%,color-mix(in_srgb,hsl(var(--secondary))_75%,black)_8%,color-mix(in_srgb,hsl(var(--secondary))_75%,black)_92%,color-mix(in_srgb,hsl(var(--secondary))_50%,black)_100%)]",
};
