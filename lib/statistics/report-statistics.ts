// Server-side report stats: single-pass calculation replacing client-side
// useMemo on large trade arrays (runs on the server, returns DTOs).
...
function computeAllMetrics(
  ...
  // Expectancy: (P_w * AvgWin) - (P_l * Abs(AvgLoss))
