  ...
  return (
    <aside aria-labelledby="storage-notice-title" className="fixed inset-x-0 bottom-0 z-[9999] p-3 sm:p-5 md:right-auto md:max-w-[430px]">
      <div className="relative rounded-2xl border border-border/80 bg-background/95 p-5 shadow-xl backdrop-blur-xl">
        <Button variant="ghost" size="icon" className="absolute right-2 top-2" onClick={dismiss} aria-label="Dismiss storage notice"><X /></Button>
        <div className="flex items-start gap-3 pr-8">
          ...
          <div>
            <h2 id="storage-notice-title" className="text-base font-semibold">Essential storage only</h2>
            <p className="mt-1 text-sm leading-6 text-muted-foreground">JJI stores the session and preferences needed to run the app. Advertising and non-essential analytics cookies are not used.</p>
          </div>
        </div>
