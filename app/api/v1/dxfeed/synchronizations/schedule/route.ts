...
import { updateDxFeedDailySyncTimeAction } from '@/server/integrations/dxfeed'
...
export async function PATCH(request: NextRequest) {
  ...
  try {
    ...
    const result = await updateDxFeedDailySyncTimeAction(
      body.accountId,
    ...
    reportError(error, {
      surface: 'api',
      operation: 'update-dxfeed-schedule',
      route: '/api/v1/dxfeed/synchronizations/schedule',
