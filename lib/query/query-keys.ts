...
export const queryKeys = {
  ...
  playbookModels: (scope: QueryScope, filters: unknown) => ['playbook', scope, 'models', filters] as const,
  backtests: (scope: QueryScope) => ['backtests', scope] as const,
  aiChats: (scope: QueryScope) => ['ai', 'chats', scope] as const,
  aiInsights: (scope: QueryScope) => ['ai', 'insights', scope] as const,
  aiReviews: (scope: QueryScope) => ['ai', 'reviews', scope] as const,
  aiProfile: (scope: QueryScope) => ['ai', 'profile', scope] as const,
