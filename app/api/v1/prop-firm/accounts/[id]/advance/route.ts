...
async function advancePropFirmAccount(request: NextRequest, { params }: RouteParams) {
  ...
  try {
    ...
    reportApiHandlerError(request, error, 'advance-prop-firm-phase')
    return NextResponse.json(
      {
        success: false,
...
export const POST = withCanonicalApiResponse(advancePropFirmAccount)
