...
export function RetryButton({ onClick }: { onClick: () => void }) { return <Button type="button" variant="secondary" size="sm" onClick={onClick}><RefreshCw className="h-3.5 w-3.5" aria-hidden />Retry</Button> }
